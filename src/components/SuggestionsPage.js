...
const SuggestionsPage = ({ onSubmit }) => (
 <Fragment>
   ...
   <div className="page-area">
     ...
     <div className="content-area">
       <div className="content-card">
         <p className="main-info">Join us in developing Vencru to better serve your growing business</p>
         <img src={handshakeIcon} alt="handshake" />
         <p className="colab-info">Collaborate on the evolution of Vencru by leaving feedback, suggesting, voting and commenting on ideas you believe in.</p>
         <div className="content-btns">
           <button className="btn green-btn" data-toggle="modal" data-target=".bd-example-modal-lg">Leave feedback</button>
